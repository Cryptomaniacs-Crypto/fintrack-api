...
describe 'Test FinanceTracker::SecureDB Class' do
  it 'SECURITY: should encrypt text' do
    test_data = 'test data'
    text_sec = FinanceTracker::SecureDB.encrypt(test_data)
  ...
  it 'SECURITY: should decrypt encrypted ASCII' do
    ...
    text_sec = FinanceTracker::SecureDB.encrypt(test_data)
    test_decrypted = FinanceTracker::SecureDB.decrypt(text_sec)
